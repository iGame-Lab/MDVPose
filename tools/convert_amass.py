...
from utils_data import split_clips
from tqdm import tqdm

fileName = open('/data/jiajun/MotionBERT/tools/data/AMASS/amass_joints_h36m_60.pkl','rb')
...
#split_id = datareader.split_clips(vid_list, n_frames=243, data_stride=81) #todo change
split_id = split_clips(vid_list, n_frames=243, data_stride=81) #todo change
